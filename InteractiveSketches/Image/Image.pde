...
void setup(){
  img1 = loadImage("tiger.png");
  img2 = loadImage("tiger.png");
  img3 = loadImage("tiger.png");
  img4 = loadImage("tiger.png");
  size(512, 512);
  img1.loadPixels();
  for(int i = 0; i < img1.pixels.length-1; i++) {
    img1.pixels[i] = img1.pixels[i] & 0xFF0000FF;
    img2.pixels[i] = img2.pixels[i] & 0xFF00FF00;
    img3.pixels[i] = img3.pixels[i] & 0xFFFF0000;
    img4.pixels[i] = img4.pixels[i] & 0xFFFF00FF;
  }
